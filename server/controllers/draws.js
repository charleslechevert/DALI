...
export const insertDraw = async (req,res) => {
    try {
        const draw = await Draw.insert({ name: "Example Draw"})
        res.status(200).json(draw)
...
export const insertDraws = async (req,res) => {
